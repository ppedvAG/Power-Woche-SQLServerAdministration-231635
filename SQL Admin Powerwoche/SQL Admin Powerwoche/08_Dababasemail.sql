...
Profil
	SMTP Konto
			...
			Authentifizierung
	Sicherheit
		öfftl Profil (Mitglied einer Gruppe: msdb..DatabaseMailuserRole  msdb)   Rolle = Gruppe
		privates Profil:  gezielte direkte Rechtevergabe am Profil
